...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> 
                <span class="nav_logo-name">Welcome,</span> </a>
                <div class="nav_list"> 
                    ...
                    <a href="#" class="nav_link"> <i class='bx bx-bookmark nav_icon'></i> <span         class="nav_name">Courses</span> 
                    </a> 
                    <a href="#" class="nav_link"> <i class='bx bx-folder nav_icon'></i> <span class=    "nav_name">Files</span>
                     </a> 
                     <a href="#" class="nav_link"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i>       <span class="nav_name">Certificate</span> 
                     </a> 
                </div>
            </div> 
    ...
    <div class="height-100 bg-light mctnr">
         <div id="par"> <p><h3><i><U>COMPLETE THE COURSES FREE OF COST WITH CERTIFICATE</U></i></h3>
<div id="br">
1.COMPUTER FUNDAMENTAL CLASESS BY FOUNDATION<br>
2.COMPUTER OPERATOR<br>
3.DATA ENTRY OPERATOR<br>
4.BASIC OF OFFICE WORK<br>
5.BASIC FINANCIAL COURSE BY FOUNDATION<br>
</div>
<div id="par"> <p><h3><i><U>MASTER COURSE OF FOUNDATION</U></i></h3>
<div id="br">
1.HTML,CSS<br>
2.C,C++<br>
3.JAVA SCRIPT<br>
...
<div id="par"> <p><h3><i><U>ADVANCE MASTER COURSE OF FOUNDATION</U></i></h3>
<div id="br">
1.Teacher Training<br>
2.Bussiness Training<br>
3.Ethical hacking Basic<br>
4.Ethical hacking<br>
<br>
</div>
